        ...
        <div class="container d-flex align-items-center justify-content-lg-between position-relative">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
                ...
                <div class="offcanvas-body">
                    <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="<?php echo get_home_url()?>" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                خانه
                            </a>
                        ...
                        <li><a href="<?php echo get_home_url()?>/blog" class="nav-link">مقالات آموزشی</a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link " href="<?php echo get_home_url()?>/#price" role="button">تعرفه ها</a>

                        </li>
                        <li><a href="<?php echo get_home_url()?>/#faq" class="nav-link">سوالات متداول</a></li>
                        <li class="nav-item dropdown">
